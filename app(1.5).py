...
if __name__ == '__main__':
    ...
    cert_file = '/Users/adityadebchowdhury/Desktop/facialrec/cert.pem'
    key_file = '/Users/adityadebchowdhury/Desktop/facialrec/key.pem'
    
    if os.path.exists(cert_file) and os.path.exists(key_file):
        socketio.run(app, host='0.0.0.0', port=5002, debug=True, ssl_context=(cert_file, key_file))
    else:
        logging.warning("SSL certificate or key file not found. Running without SSL.")
